        ...
        <script>
         ...
         <body>
             ...
             <form action="./requests/editStudent.php" method="post">
                 ...
                 <div class="group">
                     <input type="text" name="sname"><span class="highlight"></span><span class="bar"></span>
                     <label>Last Name</label>
                 </div>
                 <div class="group">
                     <input type="text" name="subject"><span class="highlight"></span><span class="bar"></span>
                     <label>Subject</label>
                 </div>
                 <div class="group">
                     <input type="number" name="year"><span class="highlight"></span><span class="bar"></span>
                     <label>Year</label>
                 </div>
                 <div class="group">
